...
func NewDriver(options *Options, efsUtilsCfgPath string) *Driver {
	...
	watchdog := newExecWatchdog(efsUtilsCfgPath, *options.EfsUtilsStaticFilesPath, *options.DebugLogs, *options.EfsCloudWatchLogEnabled, *options.S3FilesCloudWatchLogEnabled, *options.S3FilesCloudWatchMetricsEnabled, "amazon-efs-mount-watchdog")
	return &Driver{
